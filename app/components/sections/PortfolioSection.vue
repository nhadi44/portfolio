...
<template>
  ...
  >
    <!-- Background -->
    <div
      class="absolute inset-0 bg-gradient-to-b from-dark-950 via-dark-900/50 to-dark-950 -z-10"
    />
    ...
    <div class="container mx-auto px-4 md:px-8 relative z-10">
      ...
      >
        <p class="text-primary-400 font-medium mb-2">My Work</p>
      ...
      <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        >
          ...
          >
            <!-- Project Image/Icon -->
            <div
              class="h-48 bg-gradient-to-br from-primary-600/20 to-purple-600/20 rounded-xl mb-4 flex items-center justify-center relative overflow-hidden"
            >
              <span
              ...
              <div
                class="absolute inset-0 bg-primary-600/0 group-hover:bg-primary-600/10 transition-colors duration-300"
              />
              <div
                class="absolute top-3 right-3 px-2 py-1 bg-dark-900/80 backdrop-blur-sm rounded-md text-xs font-medium text-primary-400"
              >
                {{ project.year }}
              </div>
              <div
                class="absolute top-3 left-3 px-2 py-1 bg-dark-900/80 backdrop-blur-sm rounded-md text-xs font-medium text-primary-400"
              >
                {{ project.category }}
              </div>
            </div>
            ...
            <!-- Title -->
            <h3
              class="text-xl font-bold text-white mt-3 mb-2 group-hover:text-primary-400 transition-colors"
            >
              {{ project.title }}
            </h3>
            ...
            <!-- Tech Stack -->
            <div
              class="flex flex-wrap gap-2 mt-auto pt-4 border-t border-dark-700/50"
            >
              <span
                v-for="tech in project.tech"
                :key="tech"
                class="text-xs px-2 py-1 bg-dark-800 text-dark-300 rounded-md"
              >
                {{ tech }}
              </span>
            </div>
