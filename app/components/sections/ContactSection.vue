...
const handleSubmit = async () => {
  ...
  try {
    ...
    // We treat this as "success" from UI perspective because the user is taken to their email client
    submitStatus.value = "success";
    form.name = "";
    form.email = "";
    form.message = "";
...
<template>
  ...
  >
    ...
    <div class="container mx-auto px-4 md:px-8 relative z-10">
      ...
      >
        <p class="text-primary-400 font-medium mb-2">Get In Touch</p>
      ...
      <div class="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
        ...
        >
          ...
          <div class="grid sm:grid-cols-2 gap-4">
            ...
            >
              <div
                class="w-10 h-10 flex-shrink-0 rounded-xl bg-primary-500/10 flex items-center justify-center group-hover:bg-primary-500/20 transition-colors"
              >
                <!-- Email -->
                <svg
              ...
              <div class="min-w-0 flex-1">
                <p class="text-xs text-dark-400">{{ info.label }}</p>
                <p
                  class="text-white text-sm font-medium group-hover:text-primary-400 transition-colors truncate"
                >
                  {{ info.value }}
                </p>
              </div>
          ...
          <form @submit.prevent="handleSubmit" class="space-y-6">
            <div>
              ...
              <input
                ...
                class="w-full px-4 py-3 bg-dark-800/50 border border-dark-700 rounded-xl text-white placeholder-dark-500 focus:outline-none focus:border-primary-500 focus:ring-1 focus:ring-primary-500 transition-colors"
              />
            </div>
            <div>
              <label
            ...
            <div>
              ...
              <textarea
                ...
                class="w-full px-4 py-3 bg-dark-800/50 border border-dark-700 rounded-xl text-white placeholder-dark-500 focus:outline-none focus:border-primary-500 focus:ring-1 focus:ring-primary-500 transition-colors resize-none"
              />
            </div>
            <button
              type="submit"
