<template>
  <footer class="py-8 border-t border-dark-800">
    <div class="container mx-auto px-4 md:px-8">
      <div class="flex flex-col md:flex-row items-center justify-between gap-4">
        <a href="#home" class="text-xl font-bold gradient-text"
          >Hadi<span class="text-white">.</span>dev</a
        >
        <p class="text-dark-400 text-sm text-center">
          © {{ new Date().getFullYear() }} Hadi Nurhidayat. All rights reserved.
        </p>
